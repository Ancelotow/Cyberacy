...
class MessageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var tabViewMess: UITableView!
    ...
    override func viewDidLoad() {
        ...
        CStatesWebServices.MessStats{ data in
            ...
            DispatchQueue.main.async {
                self.tabViewMess.dataSource = self
                self.tabViewMess.delegate = self
                self.tabViewMess.register(UITableViewCell.self, forCellReuseIdentifier: "cell")
    ...
    @IBAction func goToGraphMess(_ sender: Any) {
        let graphMess = GraphMessViewController()
        self.navigationController?.pushViewController(graphMess, animated: true)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tabViewMess.dequeueReusableCell(withIdentifier: "cell", for: indexPath)
