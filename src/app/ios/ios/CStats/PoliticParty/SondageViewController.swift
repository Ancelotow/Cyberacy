...
class SondageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    @IBAction func goToGraphSondage(_ sender: Any) {
        let graphSondage = GraphSondageViewController()
        self.navigationController?.pushViewController(graphSondage, animated: true)
    }
