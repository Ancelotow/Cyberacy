//
//  StatesVoteViewController.swift
//  CStats
//
...
class StatesVoteViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func goToGraph(_ sender: Any) {
        let graphViewController = GraphStatesVoteViewController()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "Élection " + statsItem[indexPath.row].name_election! + " : Nombre de participation " + String(statsItem[indexPath.row].nb_participation!)
